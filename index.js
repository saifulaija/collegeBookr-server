...
async function run() {
  try {
    ...
    const collegesCollections = client
      .db("collegeBookr")
      .collection("colleges");
    const researchCollections = client
      .db("collegeBookr")
      .collection("research");
    const feedbackCollections = client
      .db("collegeBookr")
      .collection("feedback");
    const studentsCollections = client
      .db("collegeBookr")
      .collection("studentsInformation");
    const usersCollections = client.db("collegeBookr").collection("users");
